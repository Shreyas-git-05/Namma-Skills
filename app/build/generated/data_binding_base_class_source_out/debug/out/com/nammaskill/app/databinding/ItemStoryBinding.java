...
public final class ItemStoryBinding implements ViewBinding {
  ...
  private ItemStoryBinding(@NonNull MaterialCardView rootView, @NonNull TextView storyBody,
      @NonNull ImageView storyImage, @NonNull TextView storyTitle) {
  ...
  public static ItemStoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.story_body;
      TextView storyBody = ViewBindings.findChildViewById(rootView, id);
      if (storyBody == null) {
        break missingId;
      }
      ...
      return new ItemStoryBinding((MaterialCardView) rootView, storyBody, storyImage, storyTitle);
    }
